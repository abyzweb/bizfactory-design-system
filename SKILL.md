...
A. 관리자에게 요청 보내기
   → 아래 내용을 노션 페이지에 붙여넣어 주세요:
      https://www.notion.so/c68837e8a33543a6911613a8af68cc42?v=e72ca864e1bc4f65ba140f6cecfbadaa
   ...
   요청 컴포넌트 목록:
     - [컴포넌트명] ([줄 번호]) — [사용 목적]
     ...
   HTML 파일: 노션 행에 직접 첨부해 주세요.

B. 작업 마치기
   → 완성된 HTML 코드를 아래에 제공합니다. 복사해서 .html 파일로 저장하세요.
```

> 노션 MCP가 연결된 사용자는 A 선택 시 자동 등록됩니다.
